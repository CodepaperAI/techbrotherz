      ...
      "children": [
        {
          ...
          "_type": "span",
          "marks": [],
          "text": "Battery yes, screen no. The Galaxy S5 Neo stopped at Android 7. Its removable battery means a very cheap revival is possible, and that is worth doing on a working phone. A $149.99 screen on a handset from 2015 is not, because it is several times the phone's value."
        }
      ],
      "markDefs": [],
      "style": "normal"
