...
export const IMAGES: Record<string, DemoImage> = {
  ...
  "blog-screen-repair": image(
    "blog-screen-repair",
    "3:2",
    "Gloved hands lifting the screen assembly away from an opened phone, with a driver in hand",
    "max bushuev",
    "U46ib4fUniY",
  ),
  "blog-slow-computer": image(
    "blog-slow-computer",
    "3:2",
    "A laptop cooling fan and heatsink coated in dust, seen from above on the open mainboard",
    "Zoshua Colah",
    "xdzhM0LeTt8",
  ),
  "blog-console-faults": image(
    "blog-console-faults",
    "3:2",
    "A game controller fully disassembled on a cutting mat, with its board, thumbsticks and shell laid out",
    "Sean Whelan",
    "NG_a-z0ScM0",
  ),
  "blog-laptop-signs": image(
    "blog-laptop-signs",
    "3:2",
    "A technician working inside an opened laptop with plastic spudgers, fans and battery visible",
    "Revendo",
    "KhnRiIAgvsI",
  ),
  "blog-water-damage": image(
    "blog-water-damage",
    "3:2",
    "A hand holding a rain-covered phone outdoors on an overcast day",
    "Maximus Mazar",
    "kU7Hp3fdyhs",
  ),
  "blog-unlock-canada": image(
    "blog-unlock-canada",
    "3:2",
    "SIM ejector tools, a SIM card and adapter, and a SIM tray laid out beside the back of a phone",
    "Andrey Matveev",
    "TCyYbnFBIIw",
  ),
