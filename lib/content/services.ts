...
const phoneRepair: ServiceDef = {
  ...
  process: [
    {
      ...
      body: "No appointment, no booking form. Come to the Store at 3317 17 Ave SE during opening hours and tell us what the phone is doing.",
      art: "diagnostic",
    },
    {
  ...
  sections: (c) => [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "We will always tell you the expected time at the Store before you decide. If you have somewhere to be, say so, because on a busy Saturday there may be repairs ahead of yours and it is better that you know than that you wait.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "If you want to know exactly which grade of part goes into a specific repair, ask at the Store. We would rather answer the question directly for your model than publish a blanket claim that is not true of every part we stock.",
      ],
    },
  ],
  whoFor: [
  ...
  limits: () => [
    ...
    },
    {
      ...
      body: "If the fault is on the logic board itself rather than a replaceable part, that is specialist work beyond what we do at the Store, and we will tell you rather than take the repair.",
    },
    {
  ...
  faqs: (c) => [
    ...
    },
    {
      ...
      answer: `Yes. Most phone repairs at TechBrotherz in Calgary are done at the Store in about ${c.waitMinutes} minutes, including screen and battery replacements on the models we stock parts for. Charging port work takes around 45 minutes. If the part has to be ordered in, TechBrotherz will tell you at the Store before you leave the phone.`,
    },
    {
  ...
  sections: () => [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Program installation is exactly what it sounds like: a flat price per program to have software installed and configured properly rather than left half set up. If you are having several things done at once, ask at the Store and we will tell you the total before we start.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "If a part needs ordering, that adds a day or two and we will say so at the Store. Nothing gets started, and nothing gets charged, before you have agreed to the price and the timeframe.",
      ],
    },
  ],
  whoFor: [
  ...
  process: [
    {
      ...
      body: "We will tell you this at the Store too. If the phone is on your own account with a Canadian carrier, they are required to unlock it free of charge. Save the money if that route is open to you.",
      art: "lock",
    },
    {
...
const passwordReset: ServiceDef = {
  ...
  process: [
    ...
    {
      title: "You set a new password at the Store",
  ...
  sections: () => [
    {
      ...
      paragraphs: [
        ...
        "That advice is usually to reinstall Windows, which does restore access to the computer, and does so by removing everything that was on it. If the files on the machine matter to you, that is a very expensive way to solve a password problem. Bring it to the Store first.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "A local account is what TechBrotherz resets. The password is on the machine, and access can be restored at the Store without touching your files. If the sign-in screen shows just a name with no email address underneath, this is almost always what you have.",
        "A Microsoft account password is reset through Microsoft's own recovery process, using the recovery email address or phone number attached to the account. We will walk you through that at the Store, and there is nothing to pay, because it is not work we did. If the sign-in screen shows an email address, this is the case you are in.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "Something that links you to the machine means the original receipt, the box it came in, an account already on the computer that is in your name, or a plausible and checkable account of how you came to own it. Staff make that judgement at the Store, and they are entitled to decline.",
  ...
  limits: () => [
    ...
    },
    {
      ...
      body: "If the machine signs in with an email address, the password lives with Microsoft rather than on the computer. We will show you the recovery process at the Store, and there is nothing to pay.",
    },
  ],
  faqs: () => [
    {
...
const gameConsoleRepair: ServiceDef = {
  ...
  h1: "Gaming Console Repair in Calgary",
  eyebrow: "Console repair",
  seoTitle: "Gaming Console Repair Calgary | Xbox, PS5, Switch",
  seoDescription:
    "Gaming console repair at TechBrotherz in Calgary: Xbox One, Xbox Series X and S, PS4, PS5 and Nintendo Switch. Diagnosed first, price agreed before any work.",
  ...
  process: [
    ...
    },
    {
      ...
      body: "Completed console repairs are covered by the same warranty as every other repair at the Store. Bring it straight back if the fault returns inside that period.",
      art: "battery",
    },
  ],
  sections: (c) => [
  ...
  faqs: (c) => [
    {
      question: "Does TechBrotherz repair gaming consoles in Calgary?",
      answer:
    ...
    },
    {
      ...
      answer: `Yes. Console repairs at TechBrotherz in Calgary carry the same ${c.warrantyDays}-day warranty as every repair at the Store. If the repaired fault returns inside that period, bring the console straight back.`,
    },
  ],
  globalCategories: ["walkin", "warranty"],
  sources: [],
