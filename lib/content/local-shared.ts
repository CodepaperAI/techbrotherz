 ...
 * best facts the site has are true of every page at once: there is one shop,
...
export const SHARED_FACTS: Record<FactId, SharedFact> = {
  transitway: {
    ...
    note: "The strongest local fact on the site. A MAX Purple station on a dedicated bus-only transitway at the door. Spread across eleven pages it reads as boilerplate; concentrated it reads as a reason to choose this shop.",
  },
  "international-avenue": {
    id: "international-avenue",
    label: "International Avenue, the BRZ and where the shop actually sits",
    homePath: "/locations/calgary",
