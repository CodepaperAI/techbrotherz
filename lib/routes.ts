...
export const ROUTES: RouteDef[] = [
  ...
  /* --- Tier 4, brand hubs. Model pages are dynamic, see isModelRoute. --- */
  {
    ...
    label: "iPhone repair prices",
    tier: "brand",
    status: "built",
    parent: "/repair-prices",
  },
  {
    path: "/repair/apple-ipad",
    label: "iPad repair prices",
    tier: "brand",
    status: "built",
    parent: "/repair-prices",
  },
  {
    ...
    label: "Samsung Galaxy repair prices",
    tier: "brand",
    status: "built",
    parent: "/repair-prices",
  },
  {
    ...
    label: "Google Pixel repair prices",
    tier: "brand",
    status: "built",
    parent: "/repair-prices",
  },
  {
    ...
    label: "Google Nexus repair prices",
    tier: "brand",
    status: "built",
    parent: "/repair-prices",
  },
  ...
  },
  {
    ...
    label: "Laptop and desktop repair prices",
    tier: "brand",
    status: "built",
    parent: "/repair-prices",
  },
