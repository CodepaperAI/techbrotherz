...
export const ROUTES: RouteDef[] = [
  ...
  {
    path: "/buy-sell-trade",
    label: "Buy, sell and trade devices",
    navLabel: "Buy & sell",
    tier: "core",
    status: "built",
    parent: "/",
  ...
  /*
   * The guides tier ships at /blog, the client's word for it, starting 2026-08
   * with three articles. The remaining planned articles keep pending /blog
   * rows below and follow later.
   */
  {
    path: "/blog",
  ...
  {
    path: "/services/frp-removal",
    label: "Google unlocking and FRP removal",
    navLabel: "FRP removal",
    tier: "service-hub",
    status: "built",
    parent: "/services",
  },
