...
| `/services/frp-removal`                            | frp removal calgary                      | google account unlock calgary, frp lock       |
| `/buy-sell-trade`                                  | sell my phone calgary                    | sell my laptop calgary, buy used phones calgary |
...
| 9      | **Data recovery. ANSWERED 2026-08: offered**, named in the client's own laptop repair list. Added as a repair type (`data-recovery`) rendered on the laptop and computer pages; a dedicated page remains future work if search volume justifies it. | Repair type live. |
...
| 15     | **Sales. ANSWERED 2026-08: the Store buys, sells and trades phones, computers and laptops.** `/buy-sell-trade` is live with the confirmed scope; new-vs-refurbished and trade-against-repair mechanics remain question 30. | Page live, no prices, quotes at the Store. |
