...
| 8      | **Real Google review count and star rating,** plus the Google Business Profile URL. `AggregateRating` schema stays off until this is supplied.                                                                                                | Reviews URL supplied 2026-08 and linked in the footer site-wide. The rating and count are still unverified, so no rating is shown and no rating schema is emitted. A Maps API key or the numbers themselves unblock the review wall. |
