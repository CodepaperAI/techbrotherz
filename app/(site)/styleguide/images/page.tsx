      ...
      <Section>
        <Container>
          <Heading
            level={1}
            eyebrow="Styleguide"
            lead="Every demo image at its real crop. These are placeholders for photography the client has not taken yet, and none of them is presented as the shop, its staff or its customers."
          >
            Image contact sheet
          </Heading>
